...
fn main() {
    ...
    let commands: Vec<Command> = vec![
        ...
        FunctionCode::GCode(GCode::InterpolationMode(InterpolationMode::CounterclockwiseCircular)).into(),
        FunctionCode::DCode(
            DCode::Operation(
        ...
        FunctionCode::GCode(GCode::InterpolationMode(InterpolationMode::ClockwiseCircular)).into(),
        FunctionCode::DCode(
            DCode::Operation(
                Operation::Interpolate(
                    Coordinates::new(
